    ...
    extend: {
      colors: {
        ...
        christmas: {
          ...
          midnight: "hsl(var(--christmas-midnight))",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(0 72% 50% / 0.4)" },
          "50%": { boxShadow: "0 0 40px hsl(0 72% 50% / 0.6), 0 0 60px hsl(45 93% 55% / 0.3)" },
        },
        "slide-in": {
        ...
        "snowfall": {
          ...
          "100%": { transform: "translateY(110vh) translateX(50px) rotate(360deg)", opacity: "0.5" },
        },
        "twinkle": {
